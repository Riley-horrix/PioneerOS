...
u32_t beth(u32_t bg32) {
    if (beTest) {
        ...
        return ((bg32 & 0xff) << 24) | ((bg32 & 0xff00) << 8)
		| ((bg32 & 0xff0000) >> 8) | ((bg32 & 0xff000000) >> 24);
    }
}
...
u64_t bethl(u64_t bg64) {
    if (beTest) {
        ...
        return ((bg64 & 0xff) << 56) | ((bg64 & 0xff00) << 40) | ((bg64 & 0xff0000) << 24) | ((bg64 & 0xff000000) << 8) | ((bg64 & 0xff00000000) >> 8) | ((bg64 & 0xff0000000000) >> 24) | ((bg64 & 0xff000000000000) >> 40) | ((bg64 & 0xff00000000000000) >> 56);
    }
}